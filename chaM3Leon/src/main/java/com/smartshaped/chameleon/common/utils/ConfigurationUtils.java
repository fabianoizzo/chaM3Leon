...
public abstract class ConfigurationUtils {
    ...
    private static final String CASSANDRA_KEYSPACE_REPLICATION = "cassandra.keyspace.replicationFactor";
     ...
     *
     * <p>This constructor initializes the configuration utility by loading the
     * configuration file specified by the {@code mainConfigFile} parameter.
     * The configuration file is processed to look for the "include" keyword and
     * the specified configuration file is loaded and merged with the current one.
     *
     * <p>The configuration of the custom interpolator is also set up here.
     *
     * @throws ConfigurationException if a configuration file is not found or is
     *                                invalid
     */
    ...
    /**
     * Recursively processes the configuration file looking for the "include"
     * keyword, and loads the specified configuration file, merging it with the
     * current one. The "include" keyword is then removed from the configuration
     * after processing.
     *
    ...
    /**
     * Retrieves the Spark configuration as a SparkConf object. The configuration is
     * loaded from the configuration file and the keys are prefixed with the value
     * of the confRoot variable. The configuration is then processed and the
     * relevant SparkConf settings are set.
     *
    ...
    /**
     * Returns the Cassandra key space as specified in the configuration file. If no
     * key space is specified, an empty string is returned.
     *
    ...
    /**
     * Returns the replication factor of the Cassandra key space as specified in the
     * configuration file. If no replication factor is specified, the default
     * replication factor of 1 is used.
     *
    ...
    /**
     * Returns the Cassandra node as specified in the configuration file. If no node
    ...
    /**
     * Returns the Cassandra port as specified in the configuration file. If no port
     * is specified, the default port of 9042 is used.
     *
    ...
    /**
     * Returns the Cassandra data center as specified in the configuration file. If
     * no data center is specified, an empty string is returned.
     *
     ...
     * <p>
     * The instance is created using the class name specified in the configuration
     * file. If the class name is missing or empty, a ConfigurationException is
     * thrown.
     * <p>
    ...
    public TableModel createTableModel(String className) throws ConfigurationException {
        ...
        try {
            ...
            throw new ConfigurationException("Could not instantiate " + TableModel.class + " due to exception", e);
        }
